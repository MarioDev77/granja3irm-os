// ATENÇÃO: esta é uma CÓPIA de backend/lib/rbac.js. Aqui ela serve apenas para
// a interface (esconder itens de menu, redirecionar páginas). A fonte da verdade
// — e o que realmente protege os dados — é a cópia do back-end. Se você mudar
// permissões, altere os DOIS arquivos.
//
// ============================================================================
